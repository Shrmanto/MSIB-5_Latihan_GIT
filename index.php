            ...
            <div class="card-body">
                <div class="card-title">
                    <div class="" style="display: flex; align-items: center;">
                        ...
                        <p style="margin-left: 35px; margin-top: 10px;">Disukai oleh <?php echo $_SESSION['angka']; ?> orang</p>
                    </div>
                </div>
                <p class="card-text mt-2">Halo, Nama saya <span style="font-weight: 700;">Suhermanto</span>, Saya merupakan mahasiswa <span style="font-weight: 700;">informatika</span> dari <span style="font-weight: 700;">Universitas Jember</span>. Saya telah dipilih sebagai <span style="font-weight: 700;">Full Stack Web Development</span> di <span style="font-weight: 700;">PT Gits Indonesia</span>. Hobi saya yaitu bermain <span style="font-weight: 700;">Game</span>, <span style="font-weight: 700;">Makan</span> (Prioritas) dan <span style="font-weight: 700;">Olahraga</span> (kalo inget). Rencana kedepannya mau menjadi Rektor kampus😂.
